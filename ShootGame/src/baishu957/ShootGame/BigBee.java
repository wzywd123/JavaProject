...
/**
 * 大蜜蜂类（BigBee）继承自飞行物类（FlyingObj），实现了奖励（Award）接口
 * @author baishu
...
public class BigBee extends FlyingObj implements Award{
	 ...
	 */
	public void step() {
		x += xSpeed;//大蜜蜂对象做X轴的横向移动
		/*
		 * 当大蜜蜂对象到达窗口边缘，即x >= 窗口width-this.width时
		 * 改变xSpeed = -xSpeed,使大蜜蜂对象在X轴上做反向移动
		 */
